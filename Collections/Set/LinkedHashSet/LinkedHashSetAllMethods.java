...
public class LinkedHashSetAllMethods {
    ...
    public static void main(String[] args) {
        ...
        // LinkedHashSet() → creates empty set maintaining insertion order

        LinkedHashSet<Integer> set2 = new LinkedHashSet<>(20);
        // LinkedHashSet(int capacity) → creates set with given capacity
        ...
        // LinkedHashSet(Collection) → creates set from another collection
        ...
        // removeAll(Collection) → removes all specified elements
